...
EN = {
    ...
    "s7": dict(eyebrow="BSAI economics &amp; revenue trajectory", h="BSAI — fixed supply, [sun]fair launch[/].",
...
DE["s7"] = dict(eyebrow="BSAI-Ökonomie &amp; Umsatzkurve", h="BSAI — feste Supply, [sun]fairer Launch[/].",
